...
export async function GET(req: Request) {
  ...
  const res = await fetch(`${solverUrl}/projects/${projectId}/nurses${nurseId ? `/${nurseId}` : ""}`, {
    method: "GET",
    headers: {
...
export async function POST(req: Request) {
  ...
  const res = await fetch(`${solverUrl}/projects/${projectId}/nurses`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function PUT(req: Request) {
  ...
  const res = await fetch(`${solverUrl}/projects/${projectId}/nurses/${nurseId}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
