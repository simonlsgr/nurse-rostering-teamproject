...
nurse_rostering._solver_v0_router = APIRouter(tags=["Nurse_Rostering_solver_v0"])

@nurse_rostering._solver_v0_router.post("/jobs", response_model=NurseRosteringJobStatus)
def post_job(
...
@nurse_rostering._solver_v0_router.get("/jobs/{task_id}", response_model=NurseRosteringJobStatus)
...
@nurse_rostering._solver_v0_router.get("/jobs/{task_id}/solution", response_model=NurseRosteringSolution)
...
@nurse_rostering._solver_v0_router.delete("/jobs/{task_id}")
...
@nurse_rostering._solver_v0_router.get("/jobs", response_model=list[NurseRosteringJobStatus])
...
app.include_router(nurse_rostering._solver_v0_router, prefix="/nurse_rostering._solver/v0")