...
from nurse_rostering.solvers.hexaly.model.modules_ip import MaximumNumberOfWeekendsModuleIP
...
def test_maximum_number_of_weekends_feasible():
    ...
    with AssertModelFeasible() as model:
        ...
        MaximumNumberOfWeekendsModuleIP().build(instance, model, [nurse_vars])
