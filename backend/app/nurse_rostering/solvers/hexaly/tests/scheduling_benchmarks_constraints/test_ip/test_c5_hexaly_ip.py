...
from nurse_rostering.solvers.hexaly.model.modules_ip import MaximumConsecutiveShiftsModuleIP
...
def test_maximum_consecutive_shifts_feasible():
    ...
    with AssertModelFeasible() as model:
        ...
        MaximumConsecutiveShiftsModuleIP().build(instance, model, [nurse_vars])
