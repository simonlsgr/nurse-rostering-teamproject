...
from nurse_rostering.solvers.hexaly.model.modules_ip import MinimumConsecutiveDaysOffModuleIP
...
def test_minimum_consecutive_days_off_feasible():
    ...
    with AssertModelFeasible() as model:
        ...
        MinimumConsecutiveDaysOffModuleIP().build(instance, model, [nurse_vars])
