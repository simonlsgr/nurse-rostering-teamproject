...
from nurse_rostering.solvers.hexaly.model.modules import MinimumConsecutiveShiftsModule
...
def test_maximum_consecutive_shifts_feasible():
    ...
    with AssertModelFeasible() as model:
        ...
        MinimumConsecutiveShiftsModule().build(instance, model, [shift_vars_1, shift_vars_2, shift_vars_3])
...
def test_maximum_consecutive_shifts_infeasible():
    ...
    with AssertModelInfeasible() as model:
        ...
        MinimumConsecutiveShiftsModule().build(instance, model, [shifts_vars_1, shifts_vars_2, shifts_vars_3])
